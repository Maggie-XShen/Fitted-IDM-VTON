...
def parse_arguments():
    ...
    parser.add_argument('--garm_img', type=str, required=True, help='URL or path to the garment image')
    parser.add_argument('--garment_des', type=str, required=True, help='Description of the garment')
    parser.add_argument('--is_checked', action='store_true', help='Use auto-generated mask')
    parser.add_argument('--is_checked_crop', action='store_true', help='Use auto-crop & resizing')
